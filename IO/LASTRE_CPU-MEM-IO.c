...
ADDR=0x1; 	BUS=0x9; 	MainMemory();
ADDR=0x2; 	BUS=0x48; 	MainMemory();
ADDR=0x3; 	BUS=0x0; 	MainMemory();
ADDR=0x4; 	BUS=0x70; 	MainMemory();
ADDR=0x5; 	BUS=0x0; 	MainMemory();
ADDR=0x6; 	BUS=0x30; 	MainMemory();
ADDR=0x7; 	BUS=0x0; 	MainMemory();
ADDR=0x8; 	BUS=0x28; 	MainMemory();
ADDR=0x9; 	BUS=0x1; 	MainMemory();
ADDR=0xa; 	BUS=0xA0; 	MainMemory();
ADDR=0xb; 	BUS=0x16; 	MainMemory();
ADDR=0xc; 	BUS=0x30; 	MainMemory();
ADDR=0xd; 	BUS=0x1; 	MainMemory();
ADDR=0xe; 	BUS=0xE8; 	MainMemory();
ADDR=0xf; 	BUS=0x0; 	MainMemory();
ADDR=0x10; 	BUS=0x58; 	MainMemory();
ADDR=0x11; 	BUS=0x0; 	MainMemory();
ADDR=0x12; 	BUS=0x18; 	MainMemory();
ADDR=0x13; 	BUS=0x4; 	MainMemory();
ADDR=0x14; 	BUS=0xF8; 	MainMemory();
ADDR=0x15; 	BUS=0x0; 	MainMemory();
